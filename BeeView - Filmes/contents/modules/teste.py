...
from contents.modules.oscar_brasil_app import OscarBrasilWindow # <-- Adicione esta linha
...
class HomePageTestApp(ctk.CTkFrame):
    ...
    def _open_oscar_app(self):
        ...
        try:
            ...
            self.oscar_app_window = OscarBrasilWindow(master=self.master_window)  # Passe o master
    ...
    def _open_analysis_report(self):
        ...
        html_file_path = os.path.join(script_dir,
                                      "C:\\Users\\wilha\\Desktop\\BeeView -Aplicativo Definitivo\\contents\\modules\\relatorio_analise..html")  # Certifique-se que o nome do arquivo HTML está correto aqui
